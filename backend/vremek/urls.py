...
from .views import KommentekViewSet, RegisterView, UserListView, DeleteUserView, EgitestekViewSet, EsemenyekViewSet, CikkekViewSet
...
router.register(r'kommentek', KommentekViewSet)
